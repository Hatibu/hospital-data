        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <form action="../Logics/login_fun.php" method="POST">
                  <div class="form-group">
                    <label for="email" class="sr-only">Email</label>
                    <input type="number" name="phone_num" id="email" class="form-control" placeholder="Phone number">
                  </div>
                  <div class="form-group mb-4">
                    <label for="password" class="sr-only">Password</label>
                    <input type="password" name="pass_word" id="password" class="form-control" placeholder="***********">
                  </div>
