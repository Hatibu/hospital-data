...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/
		...
		<div class="modal-content">
			<div class="modal-header justify-content-center">
				<div class="icon-box" id="icon-box">
					<i class="material-icons confirm-icon">&#xE876;</i>
				</div>
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			</div>
			<div class="modal-body text-center">
				<h4>Asante kwa Maoni yako!</h4>	
				<p>Maoni yako yatafanyiwa kazi ili kuboresha huduma zetu.</p>
